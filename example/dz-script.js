      ...
      if (current === '<') {
        ...
        if (status === sign_enum.SIGN_END) {
          ...
          use_line.map((i) => {
            var _a;
            node =
              (_a = node === null || node === void 0 ? void 0 : node.children) === null || _a === void 0
                ? void 0
                : _a[i];
          });
          sign = '';
  ...
  class updateWorkerjs {
    ...
    _getCurrentHash(htmlObj) {
      for (const child of htmlObj.children) {
        if (
          (child === null || child === void 0 ? void 0 : child.nodeName) === 'script' &&
          (child === null || child === void 0 ? void 0 : child.src)
        ) {
          return child.src;
        }
        // 递归查找子节点
